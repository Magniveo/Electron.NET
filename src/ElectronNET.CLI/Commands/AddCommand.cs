...
public class AddCommand : ICommand
{
    ...
    public const string COMMAND_DESCRIPTION =
        "The add command needs to be invoked via 'add hosthook'. This creates a special folder for your custom npm package installation.";

    public const string COMMAND_ARGUMENTS = "hosthook";

    private static readonly string ElectronHostHookFolderName = "ElectronHostHook";
    ...
    public Task<bool> ExecuteAsync()
    {
        return Task.Run(() =>
        {
            ...
            {
                Console.WriteLine(
                    "ElectronHostHook directory already in place. If you want to start over, delete the folder and invoke this command again.");
                return false;
            }
            ...
            Console.WriteLine(
                $"Found your {extension}: {projectFile} - check for existing CopyToPublishDirectory setting or update it.");
