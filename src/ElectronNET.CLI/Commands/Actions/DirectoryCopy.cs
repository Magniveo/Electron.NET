...
public static class DirectoryCopy
{
    public static void Do(string sourceDirName, string destDirName, bool copySubDirs, List<string> ignoredSubDirs)
    {
        ...
        else
        {
            ...
            foreach (var fileDel in targetDir.EnumerateFiles()) fileDel.Delete();
            foreach (var dirDel in targetDir.EnumerateDirectories()) dirDel.Delete(true);
        }
        ...
        if (copySubDirs)
            ...
            {
                if (ignoredSubDirs.Contains(subdir.Name)) continue;
