...
public static class DeployEmbeddedElectronFiles
{
    public static void Do(string tempPath)
    {
        ...
        if (Directory.Exists(vscodeFolder) == false) Directory.CreateDirectory(vscodeFolder);
        ...
        if (Directory.Exists(hostApiFolder) == false) Directory.CreateDirectory(hostApiFolder);
        ...
        if (Directory.Exists(splashscreenFolder) == false) Directory.CreateDirectory(splashscreenFolder);
