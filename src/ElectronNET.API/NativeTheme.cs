...
public sealed class NativeTheme
{
    ...
    internal static NativeTheme Instance
    {
        get
        {
            if (_nativeTheme == null)
                lock (_syncRoot)
                {
                    if (_nativeTheme == null) _nativeTheme = new NativeTheme();
                }
    ...
    /// <summary>
    ///     Setting this property to <see cref="ThemeSourceMode.System" /> will remove the override and everything will be
    ///     reset to the OS default. By default 'ThemeSource' is <see cref="ThemeSourceMode.System" />.
    ///     <para />
    ...
    ///         <item>
    ///             <description>
    ///                 Any UI Electron renders on Linux and Windows including context menus, devtools, etc. will use
    ///                 the dark UI.
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    ///         </item>
    ///     </list>
    ///     The usage of this property should align with a classic "dark mode" state machine in your application where the user
    ///     has three options.
    ///     <para />
    ///     <list type="bullet">
    ///         <item>
    ...
    /// <summary>
    ///     A <see cref="ThemeSourceMode" /> property that can be <see cref="ThemeSourceMode.System" />,
    ///     <see cref="ThemeSourceMode.Light" /> or <see cref="ThemeSourceMode.Dark" />. It is used to override (
    ///     <seealso cref="SetThemeSource" />) and
    ...
    ///     <see cref="ShouldUseDarkColorsAsync" />,
    ///     <see cref="ShouldUseHighContrastColorsAsync" /> or <see cref="ShouldUseInvertedColorSchemeAsync" /> has changed.
    ...
    public event Action Updated
    {
        add
        {
            if (_updated == null)
            {
                BridgeConnector.Socket.On("nativeTheme-updated" + GetHashCode(), () => { _updated(); });
        ...
        remove
        {
            ...
            if (_updated == null) BridgeConnector.Socket.Off("nativeTheme-updated" + GetHashCode());
        }
    }
