...
public class BrowserWindow
{
    ...
    ///     The thumbar buttons.
    /// </value>
    public IReadOnlyCollection<ThumbarButton> ThumbarButtons => _thumbarButtons.AsReadOnly();
    ...
    public event Action OnReadyToShow
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-ready-to-show" + Id, () => { _readyToShow(); });
    ...
    public event Action<string> OnPageTitleUpdated
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-page-title-updated" + Id,
                    title => { _pageTitleUpdated(title.ToString()); });
    ...
    public event Action OnClose
    {
        add
        {
            if (_close == null)
            {
                BridgeConnector.Socket.On("browserWindow-close" + Id, () => { _close(); });
    ...
    public event Action OnClosed
    {
        add
        {
            if (_closed == null)
            {
                BridgeConnector.Socket.On("browserWindow-closed" + Id, () => { _closed(); });
    ...
    public event Action OnSessionEnd
    {
        add
        {
            if (_sessionEnd == null)
            {
                BridgeConnector.Socket.On("browserWindow-session-end" + Id, () => { _sessionEnd(); });
    ...
    public event Action OnUnresponsive
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-unresponsive" + Id, () => { _unresponsive(); });
    ...
    public event Action OnResponsive
    {
        add
        {
            if (_responsive == null)
            {
                BridgeConnector.Socket.On("browserWindow-responsive" + Id, () => { _responsive(); });
    ...
    public event Action OnBlur
    {
        add
        {
            if (_blur == null)
            {
                BridgeConnector.Socket.On("browserWindow-blur" + Id, () => { _blur(); });
    ...
    public event Action OnFocus
    {
        add
        {
            if (_focus == null)
            {
                BridgeConnector.Socket.On("browserWindow-focus" + Id, () => { _focus(); });
    ...
    public event Action OnShow
    {
        add
        {
            if (_show == null)
            {
                BridgeConnector.Socket.On("browserWindow-show" + Id, () => { _show(); });
    ...
    public event Action OnHide
    {
        add
        {
            if (_hide == null)
            {
                BridgeConnector.Socket.On("browserWindow-hide" + Id, () => { _hide(); });
    ...
    public event Action OnMaximize
    {
        add
        {
            if (_maximize == null)
            {
                BridgeConnector.Socket.On("browserWindow-maximize" + Id, () => { _maximize(); });
    ...
    public event Action OnUnmaximize
    {
        add
        {
            if (_unmaximize == null)
            {
                BridgeConnector.Socket.On("browserWindow-unmaximize" + Id, () => { _unmaximize(); });
    ...
    public event Action OnMinimize
    {
        add
        {
            if (_minimize == null)
            {
                BridgeConnector.Socket.On("browserWindow-minimize" + Id, () => { _minimize(); });
    ...
    public event Action OnRestore
    {
        add
        {
            if (_restore == null)
            {
                BridgeConnector.Socket.On("browserWindow-restore" + Id, () => { _restore(); });
    ...
    public event Action OnResize
    {
        add
        {
            if (_resize == null)
            {
                BridgeConnector.Socket.On("browserWindow-resize" + Id, () => { _resize(); });
    ...
    public event Action OnMove
    {
        add
        {
            if (_move == null)
            {
                BridgeConnector.Socket.On("browserWindow-move" + Id, () => { _move(); });
    ...
    public event Action OnMoved
    {
        add
        {
            if (_moved == null)
            {
                BridgeConnector.Socket.On("browserWindow-moved" + Id, () => { _moved(); });
    ...
    public event Action OnEnterFullScreen
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-enter-full-screen" + Id, () => { _enterFullScreen(); });
    ...
    public event Action OnLeaveFullScreen
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-leave-full-screen" + Id, () => { _leaveFullScreen(); });
    ...
    public event Action<string> OnAppCommand
    {
        add
        {
            if (_appCommand == null)
            {
                BridgeConnector.Socket.On("browserWindow-app-command" + Id,
                    command => { _appCommand(command.ToString()); });
    ...
    public event Action<string> OnSwipe
    {
        add
        {
            if (_swipe == null)
            {
                BridgeConnector.Socket.On("browserWindow-swipe" + Id, direction => { _swipe(direction.ToString()); });
    ...
    public event Action OnSheetBegin
    {
        add
        {
            if (_sheetBegin == null)
            {
                BridgeConnector.Socket.On("browserWindow-sheet-begin" + Id, () => { _sheetBegin(); });
    ...
    public event Action OnSheetEnd
    {
        add
        {
            if (_sheetEnd == null)
            {
                BridgeConnector.Socket.On("browserWindow-sheet-end" + Id, () => { _sheetEnd(); });
    ...
    public event Action OnNewWindowForTab
    {
        add
        {
            ...
            {
                BridgeConnector.Socket.On("browserWindow-new-window-for-tab" + Id, () => { _newWindowForTab(); });
    ...
    {
        BridgeConnector.Socket.Emit("browserWindowSetAspectRatio", Id, aspectRatio,
            JObject.FromObject(extraSize, _jsonSerializer));
    }
    ...
    public void SetMenu(MenuItem[] menuItems)
    {
        ...
        {
            var menuItem = _items.GetMenuItem(id.ToString());
            menuItem?.Click();
        });
    }
    ...
    {
        BridgeConnector.Socket.Emit("browserWindowSetProgressBar", Id, progress,
            JObject.FromObject(progressBarOptions, _jsonSerializer));
    }
    ...
    public Task<bool> SetThumbarButtonsAsync(ThumbarButton[] thumbarButtons)
    {
        ...
        BridgeConnector.Socket.Emit("browserWindowSetThumbarButtons", Id,
            JArray.FromObject(thumbarButtons, _jsonSerializer));
        ...
        {
            var thumbarButton = _thumbarButtons.GetThumbarButton(id.ToString());
            thumbarButton?.Click();
        });
