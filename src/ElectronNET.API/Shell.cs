...
public sealed class Shell
{
    ...
    public Task<bool> WriteShortcutLinkAsync(string shortcutPath, ShortcutLinkOperation operation,
        ShortcutDetails options)
    {
        var taskCompletionSource = new TaskCompletionSource<bool>();
        ...
        BridgeConnector.Socket.Emit("shell-writeShortcutLink", shortcutPath, operation.GetDescription(),
