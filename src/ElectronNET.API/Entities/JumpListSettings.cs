...
{
    /// <summary>
    ///     The minimum number of items that will be shown in the Jump List (for a more detailed description of this value see
    ///     the
    ...
    ///     in the Jump List. These items must not be re-added to the Jump List in the next call to
    ///     <see cref="App.SetJumpList" />, Windows will
