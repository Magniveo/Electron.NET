...
public sealed class CommandLine
{
    ...
    internal static CommandLine Instance
    {
        get
        {
            if (_commandLine == null)
                lock (_syncRoot)
                {
                    if (_commandLine == null) _commandLine = new CommandLine();
                }
    ...
    ///     If you're appending an argument like <code>--switch=value</code>, consider using
    ///     <code>appendSwitch('switch', 'value')</code> instead.
    /// </summary>
