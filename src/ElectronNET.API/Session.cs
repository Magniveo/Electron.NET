...
public class Session
{
    ...
    public Task ClearAuthCacheAsync(RemovePassword options)
    {
        ...
        BridgeConnector.Socket.Emit("webContents-session-clearAuthCache", Id,
    ...
    public Task ClearStorageDataAsync(ClearStorageDataOptions options)
    {
        ...
        BridgeConnector.Socket.Emit("webContents-session-clearStorageData-options", Id,
            JObject.FromObject(options, _jsonSerializer), guid);
    ...
    {
        BridgeConnector.Socket.Emit("webContents-session-createInterruptedDownload", Id,
    ...
    {
        BridgeConnector.Socket.Emit("webContents-session-enableNetworkEmulation", Id,
            JObject.FromObject(options, _jsonSerializer));
    }
    ...
    public Task SetProxyAsync(ProxyConfig config)
    {
        ...
        BridgeConnector.Socket.Emit("webContents-session-setProxy", Id, JObject.FromObject(config, _jsonSerializer),
            guid);
